  ...
  return (
    <section ref={ref} id="services" className="py-32 lg:py-44 relative overflow-hidden" style={{ background: "#F4F8FC" }}>
      <svg className="absolute top-0 right-0 w-[200px] h-[200px] lg:w-[300px] lg:h-[300px]" viewBox="0 0 300 300" fill="none">
        <path d="M300 0C300 165.685 165.685 300 0 300L0 0L300 0Z" fill="#049DD9" fillOpacity="0.06" />
        <path d="M300 0C300 165.685 165.685 300 0 300" stroke="#049DD9" strokeOpacity="0.1" strokeWidth="1.5" />
      </svg>
      <svg className="absolute bottom-0 left-0 w-[150px] h-[150px] lg:w-[220px] lg:h-[220px]" viewBox="0 0 220 220" fill="none">
        <path d="M0 220C0 98.497 98.497 0 220 0L220 220L0 220Z" fill="#049DD9" fillOpacity="0.04" />
      </svg>
